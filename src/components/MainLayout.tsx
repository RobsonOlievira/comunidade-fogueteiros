    ...
    <div className="flex flex-col h-screen w-full bg-background overflow-hidden">
      ...
      <header className="flex items-center justify-between px-4 h-14 bg-surface border-b border-glass-border flex-shrink-0">
        ...
        <div className="flex items-center gap-1 min-w-0">
          ...
          <div className="w-px h-6 bg-glass-border mx-2 hidden md:block"></div>
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-20 bg-black/60 backdrop-blur-sm" onClick={() => setMobileOpen(false)}>
          <div className="fixed left-0 top-14 bottom-0 w-64 bg-surface border-r border-glass-border p-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <button onClick={handleLogout} className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-red-400 hover:bg-red-500/10 w-full">
